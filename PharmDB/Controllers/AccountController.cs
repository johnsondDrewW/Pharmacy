...
namespace PharmDB.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Name = new SelectList("admin", "Name", "Name"); 
            return View();
        }
        ...
        public void ChangeRole(string ID)
        {
            ...
            var temp2 = UserManager.GetRoles(temp.Id);
            if (temp2.Contains("Admin"))
            {
                UserManager.RemoveFromRole(temp.Id, "Admin");
            }
            else
            {
                UserManager.AddToRole(temp.Id, "Admin");
            }
        }
        //
        // POST: /Account/Manage
